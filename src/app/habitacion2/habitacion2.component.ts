...
import { Hab2Service } from './services/hab2.service';
import { HttpClient } from '@angular/common/http';
import { MatDialog } from '@angular/material/dialog';

@Component({
  selector: 'app-habitacion2',
  standalone: true,
  imports: [ComponenteConPalabrasComponent, CommonModule],
  templateUrl: './habitacion2.component.html',
  styleUrls: ['./habitacion2.component.css']
})
export class Habitacion2Component implements OnInit, OnDestroy {
  llamadasCamas: { habitacion: number, cama: number, message?: string }[] = [];
  habitacion1: string = 'habitacion2';
  habitacion: number = 2;
