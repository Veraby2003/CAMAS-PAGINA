...
import { Hab4Service } from './services/hab4.service';
...
@Component({
  selector: 'app-habitacion4',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './habitacion4.component.html',
  styleUrl: './habitacion4.component.css'
})
export class Habitacion4Component implements OnInit, OnDestroy {
  habitacion1: string = 'habitacion4';
  habitacion: number = 4;
